...
const Error = ({ statusCode }) => {
    return (
        <>
            <Head>
                <title>단대라이브러리 : {statusCode}</title>
                <meta property='og:title' content={`단대라이브러리 : ${statusCode}`} />
                ...
                <div className='pt-10 sm:pt-12 md:pt-16 lg:pt-20 xl:pt-28 bg-white z-10'>
                    <div className='mx-auto max-w-screen-xl px-4 sm:px-6 bg-white'>
                        <div className='text-center flex flex-col items-center'>
                            <h2 className='text-9xl font-black tracking-tight leading-tight'>{statusCode}</h2>
